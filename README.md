...
1. Download the latest `.vsix` file from [Releases](https://github.com/hercobezuidenhout/nuwetak/releases/latest)
2. Install using the VS Code CLI:
   ```bash
   code --install-extension nuwetak-1.0.0.vsix
   ```
...
- **CHANGELOG entries**: Each entry must reference a GitHub issue for tracking (e.g., "- Added feature X [#123](https://github.com/hercobezuidenhout/nuwetak/issues/123)")
